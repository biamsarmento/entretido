    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-muted-foreground mt-3">Bem-vindo de volta</p>
        </div>

        <div className="bg-card border border-muted rounded-2xl p-6">
          <button
            onClick={handleGoogleLogin}
            className="w-full flex items-center justify-center gap-3 py-3 border border-muted rounded-lg text-sm font-medium hover:bg-muted transition-colors cursor-pointer"
          >
